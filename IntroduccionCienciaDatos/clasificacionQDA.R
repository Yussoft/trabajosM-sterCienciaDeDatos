...
kfold_cv_QDA <- function(iter, tt= "test") {
  ...
  # Prediccion de knn
  lda.model <- qda(Class~., data = x_tra)
...
train.results <- mean(sapply(1:10, kfold_cv_QDA, tt="train"))
test.results <- mean(sapply(1:10, kfold_cv_QDA, tt="test"))
